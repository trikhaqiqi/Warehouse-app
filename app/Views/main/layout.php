...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url() ?>/index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Warehouse App</span>
    </a>
        ...
        <li class="nav-header">Master</li>  
          ...
          <li class="nav-item">
            <a href="<?= site_url('satuan/index'); ?>" class="nav-link">
              <i class="nav-icon fa fa-archive text-yellow"></i>
              <p class="text">Satuan</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= site_url('barang/index'); ?>" class="nav-link">
              <i class="nav-icon fa fa-boxes text-green"></i>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Created with love by <a href="https://adminlte.io">Ilyas</a>.</strong>
  </footer>
